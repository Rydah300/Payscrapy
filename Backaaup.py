...
class LicenseManager:
    ...
    def verify_license(self):
        ...
        if license_key in approved_licenses:
            ...
            # Modified: Show only License Verified and license_key in green
            print(f"\n{Fore.GREEN}License Verified: {license_key}{Style.RESET_ALL}")
            
            # Retain license information table with full details in yellow
            license_info = [
...
def main():
    try:
        ...
        print(f"\n{Fore.YELLOW}{Style.BRIGHT}{' ' * padding}{horizontal_border}{Style.RESET_ALL}")
